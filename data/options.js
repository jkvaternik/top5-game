const options = {
  ...
  "art_museums": [
    ...
    "Palacio de Cristal del Retiro (Museo Reina Sofía)",
  ...
  "concert_tours": [
    ...
    "U2 (The Joshua Tree Tours 2017 & 2019)",
    "U2 (U2 360° Tour)",
    "U2 (Vertigo Tour)"
  ],
  "actresses": [
  ...
  "university_stadiums": [
    ...
    "Cotton Bowl (University of Texas at Dallas)",
  ...
  "rivers": [
    ...
    "Huang He River",
    "Ob–Irtysh River",
    "Río de la Plata–Paraná–Rio Grande River",
    "Zaïre River",
    "Heilong Jiang River",
    "Lena River",
    "Lancang Jiang River",
    "Mackenzie–Slave–Peace–Finlay River",
    "Niger River",
    "Brahmaputra–Yarlung Tsangpo River",
    "Murray–Darling–Culgoa–Balonne–Condamine River",
    "Tocantins–Araguaia River",
    "Volga River",
    "Shatt al-Arab–Euphrates–Murat River",
    "Madeira–Mamoré–Grande–Caine–Rocha River",
    "Purús River",
    "Yukon River",
    "Indus–Sênggê Zangbo River",
    "São Francisco River",
    "Syr Darya–Naryn River",
    "Nu Jiang River",
    "Great Lakes River",
    "Rio Grande River",
