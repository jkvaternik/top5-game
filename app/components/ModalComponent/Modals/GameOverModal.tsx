    ...
    <>
      ...
      >
        <div className="flex flex-col p-12 pt-3 text-center justify-center">
          <h2 className={`text-2xl mb-8 font-bold ${montserrat.className}`}>
          ...
          {puzzle.url != null ? (
            <a
              href={puzzle.url}
              className={`underline text-sm mb-4 text-[#304d6d] dark:text-white hover:text-[#82A0BC] active:text-[#38405F]`}
              target="_blank"
            >
              Quiz Source
            </a>
